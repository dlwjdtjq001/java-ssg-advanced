...
public class User_Management_Service {
    ...
    private void insertMember(){
        ...
        try {
            ...
            String sql ="insert into testdb.users values(?,?,?,?,?)";
    ...
    private void deleteMember(){
        ...
        try {
            ...
            String sql = "delete from testdb.users where mem_id = ?";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, memId);
            int cnt = pstmt.executeUpdate();
            if(cnt>0){
    ...
    private void updateMember(){
        ...
        try {
            conn = DBUtil.getInstance().getConnection();
            String sql = "update testdb.users set mem_name=?, mem_pass=?, mem_tel=?, mem_addr=? where mem_id=?";
            pstmt = conn.prepareStatement(sql);
    ...
    private void updateMember2(){
        ...
        try {
            conn = DBUtil.getInstance().getConnection();
            String sql = "update testdb.users set " + updateField + "=? where mem_id=?";
            pstmt = conn.prepareStatement(sql);
    ...
    private void displayMember(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                System.out.println(memId + " " + memName + " " + memPass + " " + memTel + " " + memAddr);
            }
            System.out.println("===============================================");
    ...
    private int getMemberCount(String memId){
        ...
        try {
            conn = DBUtil.getInstance().getConnection();
            String sql = "select count(*) from testdb.users where mem_id=?";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, memId);
