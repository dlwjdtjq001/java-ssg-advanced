...
public class Sample {
    public static void main(String[] args) {
        ...
        System.out.println("4. " + Arrays.toString(cls.getFields()));
        System.out.println("4. " + Arrays.toString(cls.getMethods()));
        System.out.println("4. " + Arrays.toString(cls.getInterfaces()));
        System.out.println("4. " + cls.getSuperclass());
    }
